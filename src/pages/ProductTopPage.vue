<template>
  <q-page class="column">
    ...
    <div class="row q-mt-xs">
      <span class="cursor-pointer q-ml-md" @click="goToAll">ALL</span>
      <span class="cursor-pointer q-ml-md" @click="goToOutwear">OUTWEAR</span>
      <span class="cursor-pointer q-ml-md" @click="goToTop">TOP</span>
      <span class="cursor-pointer q-ml-md" @click="goToBottom">BOTTOM</span>
    </div>
...
const goToAll = () => {
  $router.push('/productall')
}
const goToOutwear = () => {
  $router.push('/productoutwear')
}
const goToTop = () => {
  $router.push('/prodcuttop')
}
const goToBottom = () => {
  $router.push('/productbottom')
}
